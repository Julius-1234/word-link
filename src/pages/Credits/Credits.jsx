  ...
  return (
    <div>
      ...
      <p>
        ...
        available dictionaries and filters. As a result, non‑existent words may
        occasionally appear, and some valid words may be rejected. <br />
      ...
      <p>
        The following resources were used only as python modules, and were only
        used to filter the dictionaries that have been used in this website.
        They are not actually included in this project.
      ...
      <p>
        ...
        <br />
        This version of pyenchant uses the hunspell libaries. Again, due to the
        way it has been used, I have no legal obligations. This was used as a
      ...
      <p>
        ...
        <br />
        Better-Profanity (python module) was also used alongside LDNOOBW_v2, as
        a second layer of protection to filter the generation dictionary.
      </p>
